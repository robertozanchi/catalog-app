...
def gdisconnect():
  ...
  if credentials is None:
    ...
    response.headers['Content-Type'] = 'application/json'
    return render_template('logout.html', response='Current user not connected.')
  ...
  if result['status'] == '200':
    ...
    response.headers['Content-Type'] = 'application/json'
    return render_template('logout.html', response='Failed to revoke token for given user.')
